...
exports.testLocationExtraction = exports.healthCheck = exports.extractLocationFromText = exports.searchPlaces = void 0;
const locationExtractionService_1 = require("../../services/locationExtractionService");
...
const extractLocationFromText = async (req, res) => {
    try {
        const { text } = req.body;
        if (!text) {
            res.status(400).json({
        ...
        const result = await locationExtractionService_1.locationExtractionService.extractLocationFromText(text);
...
exports.extractLocationFromText = extractLocationFromText;
...
const testLocationExtraction = async (req, res) => {
    try {
        const testCases = [
        ...
        for (const testText of testCases) {
            ...
            const result = await locationExtractionService_1.locationExtractionService.extractLocationFromText(testText);
            results.push({
                input: testText,
                result
            });
...
exports.testLocationExtraction = testLocationExtraction;
