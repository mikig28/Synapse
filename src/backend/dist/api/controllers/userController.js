...
exports.testTelegramBotConnectivity = exports.removeMonitoredTelegramChat = exports.validateTelegramBotToken = exports.removeTelegramBot = exports.getTelegramBotStatus = exports.setTelegramBotToken = exports.updateTelegramReportSettings = exports.addMonitoredTelegramChat = void 0;
...
// @access  Private
const testTelegramBotConnectivity = async (req, res) => {
    const userId = req.user?.id;
    if (!userId) {
        return res.status(401).json({ message: 'Not authorized, user ID not found' });
    }
...
exports.testTelegramBotConnectivity = testTelegramBotConnectivity;
