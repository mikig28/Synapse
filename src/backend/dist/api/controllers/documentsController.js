...
exports.upload = exports.downloadDocument = exports.uploadDocumentSimple = exports.getDocumentStats = exports.getHealthStatus = exports.getSimilarDocuments = exports.getProcessingStatus = exports.searchDocuments = exports.deleteDocument = exports.updateDocument = exports.createDocument = exports.uploadDocument = exports.getDocument = exports.getDocuments = void 0;
...
const getHealthStatus = async (req, res) => {
    try {
        ...
        try {
            const vectorHealth = await vectorDatabaseService_1.vectorDatabaseService.healthCheck();
        ...
        try {
            const pendingDocs = await Document_1.default.countDocuments({ 'metadata.processingStatus': 'pending' });
            const processingDocs = await Document_1.default.countDocuments({ 'metadata.processingStatus': 'processing' });
