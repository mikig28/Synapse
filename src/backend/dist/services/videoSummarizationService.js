...
exports.summarizeVideoTranscript = summarizeVideoTranscript;
exports.summarizeYouTubeVideo = summarizeYouTubeVideo;
 ...
 */
async function summarizeVideoTranscript(transcript) {
    try {
 ...
 */
async function generateIntelligentSummary(videoId) {
    try {
