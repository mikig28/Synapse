...
const telegramServiceNew_1 = require("./telegramServiceNew");
...
🔗 **View Full Report**: ${reportUrl}`;
                await (0, telegramServiceNew_1.sendAgentReportToTelegram)(agent.userId.toString(), reportTitle, reportContent);
            }
            catch (telegramError) {
