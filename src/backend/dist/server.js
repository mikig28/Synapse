...
const telegramServiceNew_1 = require("./services/telegramServiceNew"); // Import new multi-user Telegram service
const telegramBotManager_1 = require("./services/telegramBotManager"); // Import telegram bot manager
...
const whatsappImagesRoutes_1 = __importDefault(require("./api/routes/whatsappImagesRoutes")); // Import WhatsApp images routes
...
app.use('/api/v1/whatsapp/images', whatsappImagesRoutes_1.default); // Use WhatsApp images extraction routes
...
const startServer = async () => {
    try {
        ...
        await (0, telegramServiceNew_1.initializeTelegramService)(); // Initialize multi-user Telegram service
