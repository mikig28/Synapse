...
import { startupManager } from './utils/startupManager'; // Import startup manager
...
const startServer = async () => {
  try {
    ...
    // Execute all phases
    await startupManager.executePhases();
    
    console.log(`🎯 RENDER DEPLOYMENT READY - All services initialized!`);
    console.log(`⏱️ Total startup time: ${startupManager.getTotalElapsedTime()}ms`);
