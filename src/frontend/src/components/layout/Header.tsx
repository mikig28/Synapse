...
const Header: React.FC<HeaderProps> = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  return (
    <header className="bg-black/40 md:bg-transparent border-b border-white/10 shadow-lg backdrop-blur-md py-3 pr-4 md:pr-8 fixed top-0 left-0 right-0 z-50 min-h-[64px] overflow-visible">
