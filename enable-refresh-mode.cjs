...
Usage: node enable-refresh-mode.cjs [action] [agent-name]
...
Examples:
  node enable-refresh-mode.cjs enable               # Enable for all agents
  node enable-refresh-mode.cjs enable "sport agent" # Enable for specific agent
  node enable-refresh-mode.cjs disable              # Disable for all agents
  node enable-refresh-mode.cjs status               # Check status
      `);
      process.exit(0);
    }
